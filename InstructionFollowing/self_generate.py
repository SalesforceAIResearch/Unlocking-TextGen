...
from commongen_supervised.self_topK import topk_huggingface, ConstrainedHypothesis
...
def generate(
    ...
    **model_specific_kwargs
    ...
    if num_return_sequences > 1 or num_beams > 1:
        ...
        #look_goals = look_goals.unsqueeze(1).expand(batch_size, effective_batch_mult * num_beams, look_goals.shape[-1] )
        ...
        ### add --lifu
        #look_goals = look_goals.contiguous().view(
        #    effective_batch_size * num_beams, look_goals.shape[-1]
        #)  # shape: (batch_size * num_return_sequences * num_beams, len)
    ...
    while cur_len < max_length:
        ...
        if do_sample:
            ...
            pick_scores, pick_tokens, constraints, num_mets = topk_huggingface(timestep=cur_len,
                                                                               ...
                                                                               model_specific_kwargs=model_specific_kwargs)
            #print('topk input_ids', input_ids)
